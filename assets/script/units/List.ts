...
export default class List extends cc.Component {
    ...
    private _PrefabIndex: number = 0;
    get PrefabIndex(): number {
        if (!this._PrefabIndex) {
            return 0;
        }
        return this._PrefabIndex;
    }
    set PrefabIndex(index: number) {
        if (index > this.tmpPrefab.length - 1) {
            return;
        }
    ...
    _init() {
        ...
        t.setTemplateItem(cc.instantiate(t.templateType == TemplateType.PREFAB ? t.tmpPrefab[t.PrefabIndex] : t.tmpNode));
